...
export class Box extends Node {
  // @signal()
  // public declare readonly portInput: SimpleSignal<number, void>

  // @signal()
  // public declare readonly portOutput: SimpleSignal<number, void>
  ...
  public constructor(props?: BoxProps) {
    ...
    this.portOutput = createSignal(() => this.position().mul(2).add(new Vector2(-20,0)));
  }
}
